...
<head>
    ...
    <title>LaporPak | Add Kategori</title>
            ...
            <div class="content">
                ...
                <section class="content-header">
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <h1 class="h3 mb-0 text-gray-800">Add Kategori Pengaduan</h1>
                            </div>
                            <div class="col-sm-6">
                ...
                <div class="card shadow mb-4 mx-3">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary">Form Add Kategori Pengaduan</h6>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="form form-group">
                                    ...
                                    <input type="text" name="inputNamaKategori" id="txtKategori" class="form-control" placeholder="Contoh : infrastruktur" value="{{ old('inputNamaKategori') }}" required>
                                </div>
                                <div class="form form-group">
                                    <label for="txtDeskripsi">Deskripsi</label>
                                    <textarea name="txtDeskripsi" id="txtDeskripsi" class="form-control" required></textarea>
                                </div>
                            </div>
